...
class ReflectionDemo {
    ...
    public static void printClass(Class c) {
        ...
        /*
         * out.println("{"); for (Field f : c.getFields()) { out.println("  "+f.toGenericString()+";"); } for (Constructor k :
         * c.getConstructors()) { out.println("  "+k.toGenericString()+";"); } for (Method m : c.getMethods()) {
         * out.println("  "+m.toGenericString()+";"); } out.println("}");
         */
    }
