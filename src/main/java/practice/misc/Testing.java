...
public class Testing {
	...
	public static void main(String[] args) {
		 ...
		 * the permutations of the remaining letters using a recursive call. The
		 * base case is when the input is an empty string the only permutation
		 * is the empty string.
		 */
	...
	private static void permutation1(char[] arr, int index) {
	...
	private static void reverseStringUsingStringArray(String str) {
	...
	private static void reverseStringUsingCharacterArray(String str) {
	...
	private static int recursiveFibonnaci(int num) {
