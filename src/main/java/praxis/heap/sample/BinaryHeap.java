...
public class BinaryHeap<T extends Comparable<T>> implements PriorityQueue<T> {
    ...
    /**
     * Returns a String representation of BinaryHeap with values stored with heap structure and order properties.
     */
    @Override
    ...
    /**
     * Performs the "bubble down" operation to place the element that is at the root of the heap in its correct place so that the heap
    ...
    /**
     * Performs the "bubble up" operation to place a newly inserted element (i.e. the element that is at the size index) in its correct
