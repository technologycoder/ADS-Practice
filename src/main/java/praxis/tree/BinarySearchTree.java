...
public class BinarySearchTree {
    ...
    public static void main(final String[] args) {
        ...
        /*
         *
         * for (int i = 1; i < NUMS; i += 2) t.remove(new Integer(i));
         *
         * if (((Integer) (t.findMin())).intValue() != 2 || ((Integer) (t.findMax())).intValue() != NUMS - 2)
         * System.out.println("FindMin or FindMax error!");
         *
         * for (int i = 2; i < NUMS; i += 2) if (((Integer) (t.find(new Integer(i)))).intValue() != i) System.out.println("Find error1!");
         *
         * for (int i = 1; i < NUMS; i += 2) { if (t.find(new Integer(i)) != null) System.out.println("Find error2!"); }
         *
         */
    }
     ...
     */
    public void insert(final Comparable x) {
     ...
     */
    public void remove(final Comparable x) {
     ...
     * @throws DuplicateItemException if x is already present.
     */
    protected BinaryNode insert(final Comparable x, BinaryNode t) {
     ...
     * @throws ItemNotFoundException if x is not found.
     */
    protected BinaryNode remove(final Comparable x, BinaryNode t) {
     ...
     * @throws ItemNotFoundException if x is not found.
     */
    protected BinaryNode removeMin(final BinaryNode t) {
     ...
     */
    private BinaryNode find(final Comparable x, BinaryNode t) {
...
class BinaryNode implements TreePrinter.PrintableNode {
    ...
    // Constructors
    BinaryNode(final Comparable theElement) {
